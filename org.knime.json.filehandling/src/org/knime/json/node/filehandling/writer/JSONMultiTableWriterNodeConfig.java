 ...
 */
final class JSONMultiTableWriterNodeConfig extends AbstractMultiTableWriterNodeConfig<JSONValue, JSONMultiTableWriterNodeConfig> {

    private static final String WRITER_SPECIFIC_TYPE_NAME = "JSON";
     ...
     */
    JSONMultiTableWriterNodeConfig(final PortsConfiguration portsConfig,
        final String connectionInputPortGrouptName) {
        super(portsConfig, connectionInputPortGrouptName, JSONValue.class, getDefaultSerializer(), true);
    }
