...
import org.knime.core.node.util.ConfigTableModel;
...
public class KeyValuePanel extends ConfigTablePanel {
    ...
    /**
     * Create a new instance with the specified {@link KeyValueTableModel}.
     *
     * @param model The {@link KeyValueTableModel} to use.
     */
    protected KeyValuePanel(final KeyValueTableModel model) {
        super(model);
    ...
    /**
     * Create a new instance (with a new {@link KeyValueTableModel}).
     */
    public KeyValuePanel() {
        this(new KeyValueTableModel());
    }
    ...
    /**
     * @return The {@link KeyValueTableModel}.
     */
    public KeyValueTableModel getKeyValueModel() {
        return m_model;
    }

    /**
     * A {@link ConfigTableModel} for key/value pairs.
     *
     * @author Gabor
     */
    protected static class KeyValueTableModel extends AbstractTableModel implements ConfigTableModel {
        ...
        public void setValueAt(final Object aValue, final int row, final int col) {
            switch (col) {
                case 0:
                    m_keys.set(row, aValue == null ? null : aValue.toString());
                    break;
                case 1:
        ...
        /**
         * Adds a table change listener for updates on second column and copies the changes to the first.
         */
        public void addModelListenerCopyFromSecondColumn() {
            addTableModelListener(new TableModelListener() {
                ...
                public void tableChanged(final TableModelEvent e) {
                    if (e.getType() == TableModelEvent.UPDATE) {
                        if (isColumnBindingChange(e) && e.getFirstRow() == e.getLastRow()) {//single row
                            if (KeyValueTableModel.this.getValueAt(e.getFirstRow(), 0) == null) {
                                //KeyValueTableModel.this.setValueAt(KeyValueTableModel.this.getValueAt(e.getFirstRow(), 1).toString(), e.getFirstRow(), 0);
                            }
                        }
                    }
                }
                 ...
                 * @return The change was in the second column.
                 */
                private boolean isColumnBindingChange(final TableModelEvent e) {
                    return e.getColumn() == 1/* || e.getColumn() == TableModelEvent.ALL_COLUMNS*/;
                }
            });
        }
    }
    ...
    static class PasteAction extends AbstractAction {
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            try {
                ...
                m_tempModel.clear();
                m_tempModel = null;
                table.getSelectionModel().setSelectionInterval(startRow, m_endRow);
            } catch (Exception ex) {
