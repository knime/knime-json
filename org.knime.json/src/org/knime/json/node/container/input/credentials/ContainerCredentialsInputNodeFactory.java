...
public final class ContainerCredentialsInputNodeFactory extends NodeFactory<ContainerCredentialsInputNodeModel> {
     ...
     */
    @Override
    public ContainerCredentialsInputNodeModel createNodeModel() {
        return new ContainerCredentialsInputNodeModel();
    }
     ...
     */
    @Override
    public NodeView<ContainerCredentialsInputNodeModel> createNodeView(
            final int viewIndex,
            final ContainerCredentialsInputNodeModel nodeModel) {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new ContainerCredentialsInputNodeDialog();
    }
}
