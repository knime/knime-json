...
final class ContainerCredentialsInputNodeConfiguration {
    ...
    private static final String DEFAULT_PARAMETER_NAME = "credential-input";
     ...
     */
    ContainerCredentialsInputNodeConfiguration() {
     ...
     */
    ContainerCredentialsInputNodeConfiguration setDescription(final String s) {
        m_description = s;
        return this;
    }
     ...
     * @return the updated configuration
     */
    ContainerCredentialsInputNodeConfiguration setParameterName(final String value) throws InvalidSettingsException {
     ...
     * @throws InvalidSettingsException if the input does not comply with {@link ContainerCredentialsJsonSchema}
     */
     ...
     * @return the updated configuration
     */
    ContainerCredentialsInputNodeConfiguration loadInDialog(final NodeSettingsRO settings) {
        try {
