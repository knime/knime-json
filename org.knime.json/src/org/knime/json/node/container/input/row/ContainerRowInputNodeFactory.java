...
public final class ContainerRowInputNodeFactory extends NodeFactory<ContainerRowInputNodeModel> {
     ...
     */
    @Override
    public ContainerRowInputNodeModel createNodeModel() {
        return new ContainerRowInputNodeModel();
    }
     ...
     */
    @Override
    public NodeView<ContainerRowInputNodeModel> createNodeView(final int viewIndex, final ContainerRowInputNodeModel nodeModel) {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new ContainerRowInputNodeDialog();
    }
}
