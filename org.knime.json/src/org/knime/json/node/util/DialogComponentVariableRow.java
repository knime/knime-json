...
final class DialogComponentVariableRow {
    ...
    /**
     * Creates a new row in the panel of the dialog. The change listeners of the {@link SettingsModelVariables} must be
     * updated after this object was created!
     *
    ...
    private void initRow(final boolean loading) {
        ...
        parentPanel.add(makeTypeSelectionBox(),
            DialogComponentVariables.getTypeColumnConstraints(m_index + 1, DialogComponentVariables.COL_PADDING_INNER));
        parentPanel.add(name,
            DialogComponentVariables.getNameColumnConstraints(m_index + 1, DialogComponentVariables.COL_PADDING_INNER));
    ...
    private void setRowInLayout(final int row) {
        ...
        parentLayout.setConstraints(m_typeBox,
            DialogComponentVariables.getTypeColumnConstraints(destination, DialogComponentVariables.COL_PADDING_INNER));
        parentLayout.setConstraints(m_nameBox,
            DialogComponentVariables.getNameColumnConstraints(destination, DialogComponentVariables.COL_PADDING_INNER));
