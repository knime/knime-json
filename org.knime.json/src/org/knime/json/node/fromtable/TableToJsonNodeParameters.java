...
class TableToJsonNodeParameters implements NodeParameters {
    ...
    @TwinlistWidget(includedLabel = "Include", excludedLabel = "Exclude")
    ...
    /**
     * Choices provider that filters RowKeyOption based on the selected {@link Direction}
     * When Direction is {@link Direction#ColumnsOutside}, the `asKey` option is not available.
     */
    ...
    /**
     * Value provider that sets a valid {@link RowKeyOption} when {@link Direction} changes.
     * If it is {@link Direction#ColumnsOutside} and current value is `asKey`, change to `omit`.
     */
    ...
    @Widget(title = "Path separator", description = "When column names as paths is enabled, "
    ...
    static final class MissingValueHandlingPersistor implements NodeParametersPersistor<MissingValueHandling> {
        ...
        public MissingValueHandling load(final NodeSettingsRO settings) throws InvalidSettingsException {
            final var omitted = settings.getBoolean(TableToJsonSettings.CFGKEY_MISSINGS_ARE_OMITTED,
                TableToJsonSettings.DEFAULT_MISSINGS_ARE_OMITTED);
            return omitted ? MissingValueHandling.OMITTED : MissingValueHandling.AS_NULL;
        }

        @Override
        public void save(final MissingValueHandling handling, final NodeSettingsWO settings) {
            final var omitted = handling == MissingValueHandling.OMITTED;
            settings.addBoolean(TableToJsonSettings.CFGKEY_MISSINGS_ARE_OMITTED, omitted);
        }

        @Override
        public String[][] getConfigPaths() {
            return new String[][]{{TableToJsonSettings.CFGKEY_MISSINGS_ARE_OMITTED}};
        }
    }
    ...
    MissingValueHandling m_missingValueHandling =
        TableToJsonSettings.DEFAULT_MISSINGS_ARE_OMITTED ? MissingValueHandling.OMITTED : MissingValueHandling.AS_NULL;
    ...
    // the field does not expose and widget in the WebUI dialog
