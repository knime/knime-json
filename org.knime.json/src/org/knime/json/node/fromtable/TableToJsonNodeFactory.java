    ...
    public NodeDescription createNodeDescription() {
        final var config = WebUINodeConfiguration.builder()
            ...
            .shortDescription("""
                ...
                """) //
            .fullDescription("""
                Converts the selected columns content to a JSON value row-wise or column-wise. It also have an option to "undo" -with some limitations- the JSON to Table transformation and create JSON values for each row based on the column names.<br/>
                Example input table:
                <table>
