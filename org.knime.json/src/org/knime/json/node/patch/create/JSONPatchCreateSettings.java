...
final class JSONPatchCreateSettings extends RemoveOrAddColumnSettings {
    ...
    /**
     * @return the inputColumnRight (target)
     */
    final String getInputColumnRight() {
        return m_inputColumnRight;
    }

    /**
     * @param inputColumnRight the inputColumnRight to set
     */
    final void setInputColumnRight(final String inputColumnRight) {
        this.m_inputColumnRight = inputColumnRight;
    }
    ...
    protected void loadSettingsForDialogs(final NodeSettingsRO settings, final PortObjectSpec[] specs) {
        ...
        m_inputColumnRight = settings.getString(INPUT_COLUMN_RIGHT, DEFAULT_INPUT_COLUMN_RIGHT);
    }
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        m_inputColumnRight = settings.getString(INPUT_COLUMN_RIGHT);
    }
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) {
        ...
        settings.addString(INPUT_COLUMN_RIGHT, m_inputColumnRight);
    }

    /**
     * @see #getInputColumnName()
     * @return The left (source) input column name.
     */
    final String getInputColumnLeft() {
