 ...
 */
public class ServiceInputZonedDateTimeParser implements ServiceInputCellParser {

    /**
     * The concrete type of this implementation.
     */
    public static final DataType DATA_TYPE = ZonedDateTimeCellFactory.TYPE;
    ...
    public DataCell parse(final Object cellObject) throws InvalidSettingsException {
        if (cellObject instanceof String) {
            try {
                ZonedDateTime.parse((String) cellObject);
            } catch (DateTimeParseException  e) {
                throw new InvalidSettingsException("Cell object \"" + cellObject + "\" cannot be parsed to \"" + DATA_TYPE + "\"", e);
            }
            return ZonedDateTimeCellFactory.create(ZonedDateTime.parse((String) cellObject));
        } else {
