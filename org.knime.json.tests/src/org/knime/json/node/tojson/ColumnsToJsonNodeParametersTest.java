...
/**
 * Snapshot test for {@link ColumnsToJsonNodeParameters}.
 *
 * @author Magnus Gohm, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
final class ColumnsToJsonNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    ColumnsToJsonNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ColumnsToJsonNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ColumnsToJsonNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ColumnsToJsonNodeParameters.class).getParent().resolve("node_settings")
                .resolve("ColumnToJsonNodeParameters.xml");
