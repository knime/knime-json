...
/**
 * Snapshot test for {@link ContainerTableInputNodeParameters}.
 * 
 * @author Magnus Gohm, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
final class ContainerTableInputNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    ContainerTableInputNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ContainerTableInputNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ContainerTableInputNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ContainerTableInputNodeParameters.class).getParent().resolve("node_settings")
                .resolve("ContainerTableInputNodeParameters.xml");
