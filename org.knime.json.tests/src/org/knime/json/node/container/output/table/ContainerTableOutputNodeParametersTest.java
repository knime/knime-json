...
/**
 * Snapshot test for {@link ContainerTableOutputNodeParameters}.
 * 
 * @author Magnus Gohm, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("restriction")
final class ContainerTableOutputNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    ContainerTableOutputNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(ContainerTableOutputNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static ContainerTableOutputNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(ContainerTableOutputNodeParameters.class).getParent().resolve("node_settings")
                .resolve("ContainerTableOutputNodeParameters.xml");
