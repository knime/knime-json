...
final class StringToJSONNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    StringToJSONNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(StringToJSONNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static StringToJSONNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(StringToJSONNodeParameters.class).getParent().resolve("node_settings")
                .resolve("StringToJSONNodeParameters.xml");
