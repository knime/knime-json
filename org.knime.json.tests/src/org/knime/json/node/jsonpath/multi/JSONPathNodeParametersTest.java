...
/**
 * Snapshot tests for JSONPathNodeParameters.
 *
 * @author Paul Baernreuther, KNIME GmbH, Germany  
 * @author AI Migration Pipeline v1.2
 */
@SuppressWarnings("restriction")
final class JSONPathNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    JSONPathNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(JSONPathNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static JSONPathNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(JSONPathNodeParameters.class).getParent().resolve("node_settings")
                .resolve("JSONPathNodeParameters.xml");
