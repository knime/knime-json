...
/**
 * Snapshot tests for {@link JSONPatchApplyNodeParameters}.
 */
@SuppressWarnings("restriction")
final class JSONPatchApplyNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    JSONPatchApplyNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(JSONPatchApplyNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static JSONPatchApplyNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(JSONPatchApplyNodeParameters.class).getParent().resolve("node_settings")
                .resolve("JSONPatchApplyNodeParameters.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return NodeParametersUtil.loadSettings(nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    JSONPatchApplyNodeParameters.class);
            }
