 ...
 */
public class ContainerTableColumnSpecTest {
    ...
    public void testSerializeColumnSpec() throws JsonProcessingException {
        ...
        String json = objectMapper.writeValueAsString(containerTableColumnSpec);
    ...
    public void testDeserializeColumnSpec() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        ContainerTableColumnSpec serviceInputColumnSpec = objectMapper.readValue("{\"column-string\":\"string\"}", ContainerTableColumnSpec.class);
