 ...
 *
 * History
 *   23 May 2016 (Gabor Bakos): created
 */
...
/**
 * Tests for {@link JsonLikeParser} (the bad cases).
 *
 * @author Gabor Bakos
 */
@RunWith(Parameterized.class)
public class JsonLikeParserParsingErrorTests {
     ...
     */
    public JsonLikeParserParsingErrorTests(final String input) {
        m_input = input;
    }
